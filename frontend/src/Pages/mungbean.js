...
import MungBeansImage from '../Images/MungBeans.jpeg';

const MungBeansPage = () => {
    return (
        <Box bg={`url(${MungBeansImage})`} bgSize="cover" height="100vh">
        <Box
            height="100%"
            display="flex"
        ...
        >
            ...
            <Tabs isFitted variant="enclosed">
                ...
                <TabPanel>
                    <Box p="4">
                    <p>
                        MungBeans is a staple food in many parts of the world, especially in
