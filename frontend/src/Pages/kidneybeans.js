...
const KidneyBeansPage = () => {
  return (
    <Box bg={`url(${KidneyBeansImage})`} bgSize="cover" height="100vh">
      <Box
        height="100%"
        display="flex"
          ...
          <Tabs isFitted variant="enclosed">
            ...
            <TabPanels>
              <TabPanel>
                <Box p="4">
                  <p>
                    KidneyBeans is a staple food in many parts of the world, especially in
...
export default KidneyBeansPage;
