...
def get_mask(image_name,display=False):
    rgb_image_path = r"C:\Users\91892\Desktop\Git-Public\Intelligent_crop_prediction_for_farmers\cropPrediction-Django Backend\appname\segmentation\samples\nir"
    nir_image_path = r"C:\Users\91892\Desktop\Git-Public\Intelligent_crop_prediction_for_farmers\cropPrediction-Django Backend\appname\segmentation\samples\rgb"
    ...
    print(rgb_image_path + '\\' + image_name)
